...
- (void)draggingEnded:(UIPanGestureRecognizer *)gesture{
  ...
  CGFloat percentage = [self percentageDismissableWithDissmissableRadius:nonDismissableRadius centerReference:CGPointMake((CGRectGetMinX(gesture.view.frame) + (CGRectGetWidth(gesture.view.bounds) / 2)), (CGRectGetMinY(gesture.view.frame) + (CGRectGetHeight(gesture.view.bounds) / 2))) currentViewCenter:self.animator.referenceView.center];
